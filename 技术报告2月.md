...
2. 简化自动测试系统部署流程（对应 [PR #363](https://github.com/arceos-hypervisor/axvisor/pull/363)）
3. 实现多组织共享测试环境（对应 [PR #2](https://github.com/arceos-hypervisor/github-runners/pull/2)、[PR #3](https://github.com/arceos-hypervisor/github-runners/pull/3)、[PR #4](https://github.com/arceos-hypervisor/github-runners/pull/4)、[PR #11](https://github.com/arceos-hypervisor/github-runners/pull/11)）
4. 实现依赖感知的测试目标选择（对应 [PR #369](https://github.com/arceos-hypervisor/axvisor/pull/369)）
...
### 多组织共享测试环境（基于 runner-wrapper 与文件锁的实现）
...
### 依赖感知的测试目标选择（基于 xtask 分析与 CI 动态矩阵）
