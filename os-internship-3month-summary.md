...
### 代表性成果：AxVisor QEMU CI 稳定性改进（PR #363）

- PR 链接：https://github.com/arceos-hypervisor/axvisor/pull/363
- 合并状态：已合并（Merged）
...
### 代表性成果：多组织 GitHub Runner 硬件锁机制建设（github-runners）

- PR 汇总入口：https://github.com/arceos-hypervisor/github-runners/pulls?q=is%3Apr+author%3Ayoinspiration+is%3Aclosed
...
### 进行中成果：axci 规则驱动自动目标选择与测试链路重构（PR #9）

- PR 链接：https://github.com/arceos-hypervisor/axci/pull/9
- 当前状态：Open（待合并）
...
### 代表性成果：StarryOS 中 EEVDF 调度器实现与验证（feat/eevdf-scheduler）

- 仓库链接：https://github.com/yoinspiration/StarryOS/tree/feat/eevdf-scheduler
